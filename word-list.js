const wordList = [
  ...
  { word: "vanmieu", fullWord: "Văn Miếu", hint: "Quốc Tử Giám – trường đại học đầu tiên của Việt Nam." },
  ...
  { word: "quocngu", fullWord: "Quốc ngữ", hint: "Chữ viết hiện nay của người Việt, được phát triển từ chữ Latin." },
  { word: "quocca", fullWord: "Quốc ca", hint: "Bài Tiến Quân Ca do nhạc sĩ Văn Cao sáng tác." },
  { word: "docthanh", fullWord: "Tuyên ngôn độc lập", hint: "Văn kiện lịch sử do Chủ tịch Hồ Chí Minh đọc tại Ba Đình." },
